	...
	<section class="login_box_area section-margin">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="login_form_inner register_form_inner">
						<h3>회원 가입</h3>
						<form class="row login_form" method="post" action="mypage_update_ok.do" id="register_form" >
							<div class="col-md-8 form-group">
								<input type="text" class="form-control" id="id" name="id" placeholder="ID" onfocus="this.placeholder = ''" onblur="this.placeholder = 'ID'" value="${id }">
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="pwd" name="pwd" placeholder="비밀번호" onfocus="this.placeholder = ''" onblur="this.placeholder = '비밀번호'" value="${pwd }">
              </div>
              <div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="name" placeholder="이름" onfocus="this.placeholder = ''" onblur="this.placeholder = '이름'" value="${name }">
              </div>
              <div class="col-md-12 form-group">
								<input type="text" class="form-control" id="email" name="email" placeholder="이메일" onfocus="this.placeholder = ''" onblur="this.placeholder = '이메일'" value="${email }">
							</div>
		...
		<!-- 		
			...
			<ul class="nav nav-tabs" id="myTab" role="tablist" style="background-color: white;">
				...
				<div class="col-md-12 form-group">
								<input type="date" class="form-control" id="birthday" name="birthday" placeholder="생년월일" onfocus="this.placeholder = ''" onblur="this.placeholder = '생년월일'" value="${birthday }">
							</div>
				<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="tel" name="tel" placeholder="전화번호" onfocus="this.placeholder = ''" onblur="this.placeholder = '전화번호'" value="${tel }">
							</div>		
				<div class="col-md-8 form-group">
								<input type="text" class="form-control" id="post" name="post" placeholder="우편번호(000-000)" readonly onfocus="this.placeholder = ''" onblur="this.placeholder = '우편번호'" value="${post }">
				...
				<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="addr1" name="addr1" placeholder="주소" onfocus="this.placeholder = ''" readonly onblur="this.placeholder = '주소'" value="${addr1 }">
							</div>
				<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="addr2" name="addr2" placeholder="상세주소" onfocus="this.placeholder = ''" onblur="this.placeholder = '주소'" value="${addr2 }">
							</div>								
				<div class="col-md-12 form-group">
								<input type="textarea" class="form-control" id="content" name="content" placeholder="자기 소개" onfocus="this.placeholder = ''" onblur="this.placeholder = '자기 소개'" value="${content }">
							</div>										
							
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" class="button button-register w-100" style="height:40px;background:#384AEB"><p style="color: white">회원정보 수정</p></button>
								<div style="height:10px;"></div>
								<button type="button" onclick="javascript:history.back()" class="button button-register w-100" style="height:40px;"><p style="color: white">취소</p></button>
